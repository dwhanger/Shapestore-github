<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Pluralsight.ShapeStore.Login1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Seroter Shape Store :: Login</title>
</asp:Content>
                            ...
                            <table cellpadding="5">
                                ...
                                <tr>
                                    <td align="right" colspan="2">
                                        <asp:Button ID="LoginButton" runat="server" CssClass="btn btn-primary btn-large" CommandName="Login" Text="Log In" ValidationGroup="logincontrol" />
                                    </td>
                                </tr>
                            </table>
                        </td>
